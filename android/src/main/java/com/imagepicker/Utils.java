...
public class Utils {
    ...
    public static String cropFailed = "cropping_failed";
    ...
    public static void saveToPublicDirectory(Uri uri, Context context, String mediaType) {
        ...
        if (mediaType.equals("video")) {
            ...
            fileDetails.put(MediaStore.Audio.Media.DISPLAY_NAME, UUID.randomUUID().toString());
            mediaStoreUri = resolver.insert(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, fileDetails);
        } else {
    ...
    static boolean isValidRequestCode(int requestCode) {
        switch (requestCode) {
            ...
            case REQUEST_LAUNCH_AUDIO_LIBRARY: return true;
